...
//! [`rand::shuffle`](rand::seq::SliceRandom::shuffle),
//! which is basically [Fisher-Yates](https://en.wikipedia.org/wiki/Fisher%E2%80%93Yates_shuffle) algorithm. This is nice, but it requires
//! that you have a good source of random numbers in an arbitrary range.
//!
